...
# fbm / mrw / skewed_mrw / poisson_mu -- relies on 'data/' being on sys.path
# directly (as every entry point's _extend_syspath already does), matching
# how codes/*.py resolve 'potentials' etc. Source: standard_models/, ported
# from https://github.com/RudyMorel/scattering_spectra (via conditional_mgd).
...
def load_synthetic_data(
    ...
    **model_params
    ...
    :param name: fbm, poisson, mrw, smrw,
