#!/bin/bash
# Budget test A: FULL potential set, n1=10000 kept, NT lowered 40000 -> 33000.
#
# n1=10000 at NT=40000 projects to ~21 h on H100 (linear in n1 from the reference
# batch's 0.96 s/it at n1=5000) -- over the 18 h the time check allows. Test A
# keeps the particles and coarsens the time grid; test B (lamtune_full_n1_8500.sh)
# keeps the time grid and drops particles. Same seeds, same everything else, so the
