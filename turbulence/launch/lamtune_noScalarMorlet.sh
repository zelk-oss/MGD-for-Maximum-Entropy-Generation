#!/bin/bash
# lam-tuning runs, full set WITHOUT Scalar_morlet_gaussianK.
# Same protocol as lamtune_full.sh (see its header); only TERMS/EXP_NAME differ.

EXP_NAME="lamtune_noScalarMorlet"
...
# Fewer potentials than the full set -> at most as slow; tighten after the first run
TIME="20:00:00"
